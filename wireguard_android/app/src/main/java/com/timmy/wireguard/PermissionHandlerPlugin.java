...
public class PermissionHandlerPlugin implements MethodChannel.MethodCallHandler {
    ...
    public static String CHANNEL = "flutter.baseflow.com/permissions/methods";
    ...
    private PermissionHandlerPlugin(PluginRegistry.Registrar mRegistrar) {
    ...
    private List<String> getManifestNames(@PermissionGroup int permission) {
        ...
        switch (permission) {
            ...
            case PERMISSION_GROUP_IGNORE_BATTERY_OPTIMIZATIONS:
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && hasPermissionInManifest(Manifest.permission.REQUEST_IGNORE_BATTERY_OPTIMIZATIONS))
